/**
 * Title: UVController.java
 * Controller class of user watching videos.
 * @author Shuhan Zhang
 * @version 5.0
 */
import java.io.*;
...
public class UVController implements ActionListener{
	private JPanel uvPanel;
	private JTextField searchTag;
	private JButton search;
	private String thisID;
	private int MAX_VIDEO=9;
	public UVController(String userID) {
		thisID=userID;
	...
	public JPanel displayVideo(String tag) {
		JPanel videoPanel=new JPanel(new GridLayout(3,0,15,15));
		try {
			int videoCount=0;
