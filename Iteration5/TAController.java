/**
 * Title: TAController.java
 * Controller class of managing trainer account information.
 * @author Shuhan Zhang
 * @version 5.0
 */
import java.io.*;
				...
				for(int i=0;i<this.pairList.length;i++) {
					if(this.pairList[i].equals(notiAttr[1])) {
						...
						if(notiAttr[2].equals("live")) {
							...
							String cnt="Live session at "+notiAttr[3]+" has been canceled.";
