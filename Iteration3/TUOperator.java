...
public class TUOperator implements ActionListener {
	...
	public TUOperator(String ID,String[] pair) {
		this.trainerID=ID;
		this.pairList=pair;
	...
	public JPanel createMyTPane(String uID) {
		...
		try {
			...
			if(this.userNum==0) {
				...
				JPanel infoSPanel=new JPanel(new GridLayout(0,2,10,10));
				infoContentPanel.setLayout(new GridLayout(6,0,5,5));
				if(isInfoFound) {
					JLabel infok1=new JLabel("Height: "+infoList[0]+"cm",JLabel.LEFT);
					infoContentPanel.add(infok1);
					JLabel infok2=new JLabel("Weight: "+infoList[1]+"kg",JLabel.LEFT);
					infoContentPanel.add(infok2);
					JLabel infok3=new JLabel("BMI: "+infoList[2],JLabel.LEFT);
					infoContentPanel.add(infok3);
					JLabel infok4=new JLabel("BF Rate: "+infoList[3]+"%",JLabel.LEFT);
					infoContentPanel.add(infok4);
					JLabel infok5=new JLabel("Focus: "+infoList[4],JLabel.LEFT);
					infoContentPanel.add(infok5);
					JLabel infok6=new JLabel("Req: "+infoList[5],JLabel.LEFT);
					infoContentPanel.add(infok6);
					infoContentPanel.setOpaque(false);
					infoContentPanel.setBorder(new EmptyBorder(0,10,0,0));
					
					BufferedImage bodyIstImg=ImageIO.read(new File("./imgs/UA/userbodyinfo.png"));
					ImageIcon bodyIstIcon=new ImageIcon();
					bodyIstIcon.setImage(bodyIstImg.getScaledInstance(180,180,Image.SCALE_DEFAULT));
					JLabel bodyIstLabel=new JLabel(bodyIstIcon);
					infoSPanel.add(infoContentPanel);
					infoSPanel.add(bodyIstLabel);
					infoSPanel.setBorder(new EmptyBorder(10,10,10,0));
