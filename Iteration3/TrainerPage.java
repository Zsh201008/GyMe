...
public class TrainerPage extends JFrame implements ActionListener{
	...
	private TAOperator ta;
	private TVOperator tv;
	private TUOperator tu;
	...
	public TrainerPage(String trainerID){
		...
		this.ta=new TAOperator(trainerID,this.pairList);
		this.tv=new TVOperator(trainerID,this.pairList);
		this.tu=new TUOperator(trainerID,this.pairList);
